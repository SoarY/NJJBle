...
//        mPaintLine.setStrokeWidth(5);
        ...
        mPaintCircle.setColor(0xF6E0CE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制空心圆
        mPaintLine.setColor(Color.parseColor("#F6E0CE"));
        canvas.drawCircle(viewSize / 2.0f, viewSize / 2.0f, viewSize / 2.0f, mPaintLine);

        mPaintLine.setColor(Color.parseColor("#F8C699"));
        canvas.drawCircle(viewSize / 2.0f, viewSize / 2.0f, viewSize / 3.0f, mPaintLine);

        mPaintLine.setColor(Color.parseColor("#FBA24F"));
...
//        canvas.drawLine(viewSize / 2.0f, 0, viewSize / 2.0f, viewSize, mPaintLine);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        SweepGradient shader = new SweepGradient(viewSize / 2.0f, viewSize / 2.0f, Color.TRANSPARENT, Color.parseColor("#FBA24F"));
    ...
    public interface OnPointUpdateListener {
        ...
        void OnUpdate(Canvas canvas, Paint paintPoint, float cx, float cy, float radius);
