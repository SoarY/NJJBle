...
import com.njj.njjsdk.library.connect.request.BleConnectRequest;
import com.njj.njjsdk.library.connect.request.BleIndicateRequest;
import com.njj.njjsdk.library.connect.request.BleMtuRequest;
import com.njj.njjsdk.library.connect.request.BleNotifyRequest;
import com.njj.njjsdk.library.connect.request.BleReadDescriptorRequest;
import com.njj.njjsdk.library.connect.request.BleReadRequest;
import com.njj.njjsdk.library.connect.request.BleReadRssiRequest;
import com.njj.njjsdk.library.connect.request.BleRefreshCacheRequest;
import com.njj.njjsdk.library.connect.request.BleRequest;
import com.njj.njjsdk.library.connect.request.BleUnnotifyRequest;
import com.njj.njjsdk.library.connect.request.BleWriteDescriptorRequest;
import com.njj.njjsdk.library.connect.request.BleWriteNoRspRequest;
import com.njj.njjsdk.library.connect.request.BleWriteRequest;
...
public class BleConnectDispatcher implements IBleConnectDispatcher, RuntimeChecker, Handler.Callback {
    ...
    private static final int MAX_REQUEST_COUNT = 9000000;
